...
class CylinderPlaneModeller:
    ...
    def visualize_cylinders(self, cylinders, header):
        ...
        for i, cylinder in enumerate(cylinders):
            ...
            marker_array.markers.append(marker)
            print("hullhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhhjkh,",marker.pose.position.x, marker.pose.position.y, marker.pose.position.z)   
        # publish
        self.cylinder_marker_pub.publish(marker_array)
...
if __name__ == "__main__":
    ...
    #   pose:
    #     position:
    #       x: 12.685666743678382
    #       y: -8.281760753610177
    #       z: 2.772966063897641
    #     orientation:
    #       x: 2.981480466133577e-05
    #       y: -0.00010562864391760164
    #       z: 0.9778562289354499
    #       w: 0.20927776634369938
    #   scale:
    #     x: 4.7954579185521915
    #     y: 4.7954579185521915
    #     z: 4.169856567183585
    #   color:
    #     r: 1.0
    #     g: 0.0
